...
CUDA_VISIBLE_DEVICES="$TRAIN_GPU" python -u -m ocrap.cli train \
  ...
  --set model.direct_recovery_semantic_witness_action_response_adapter="${SEMANTIC_WITNESS_ACTION_RESPONSE_ADAPTER:-false}" \
  --set model.direct_recovery_semantic_witness_action_response_state_conditioning="${SEMANTIC_WITNESS_ACTION_RESPONSE_STATE_CONDITIONING:-false}" \
  --set model.direct_recovery_semantic_witness_action_root_bilinear_interaction="${SEMANTIC_WITNESS_ACTION_ROOT_BILINEAR_INTERACTION:-false}" \
  --set model.direct_recovery_semantic_witness_quotient_tail_response="${SEMANTIC_WITNESS_QUOTIENT_TAIL_RESPONSE:-false}" \
  ...
  --set training.direct_value_action_response_truth_index="${ACTION_RESPONSE_TRUTH_INDEX:-}" \
