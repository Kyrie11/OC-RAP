...
export OCRAP_V48_74_CANONICAL_CACHE_KEY="v48_74_svbw_schema10_shared"
export PERSISTENT_TENSOR_CACHE_BUILD_WORKERS="${PERSISTENT_TENSOR_CACHE_BUILD_WORKERS:-8}"
...
export PERSISTENT_TENSOR_CACHE_DIR="${V4873_TENSOR_CACHE_DIR:-$OCRAP_ROOT/.ocrap_tensor_cache_v4873_svbw}"
...
train_svbw_arm(){
  ...
  train_one(){
    ...
    EVIDENCE_ADAPT_EPOCHS="${V4873_SVBW_EPOCHS:-20}" EVIDENCE_ADAPT_PATIENCE="${V4873_SVBW_PATIENCE:-5}" EVIDENCE_ADAPT_LR="${V4873_SVBW_LR:-0.001}" MAX_EVIDENCE_CALIBRATOR_PARAMS=2 \
