...
: "${CONTACT_SUPPLEMENT_COMPARATIVE_MODE:=failure_only}"
: "${CONTACT_SUPPLEMENT_MIN_EXTERNAL_FAILURES:=1}"
: "${CONTACT_SUPPLEMENT_MIN_COMPARATIVE_EVIDENCE_METHODS:=1}"
...
FINAL_ARGS=(
  ...
  --comparative-mode "$CONTACT_SUPPLEMENT_COMPARATIVE_MODE"
  --min-external-recovery-failures "$CONTACT_SUPPLEMENT_MIN_EXTERNAL_FAILURES"
  --min-comparative-evidence-methods "$CONTACT_SUPPLEMENT_MIN_COMPARATIVE_EVIDENCE_METHODS"
