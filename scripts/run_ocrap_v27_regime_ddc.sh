...
# v27 is a regime-conditioned DDC/Guarded-NARC correction on top of the v22 model.  By default it
# reuses the v22 checkpoint/calibration, so you can test the hypothesis without
# spending another training run.  Override CKPT/CAL/GAMMA if you retrain.
export RUN=${RUN:-runs/ocrap_v27_regime_ddc}
export BASE_RUN=${BASE_RUN:-runs/ocrap_v22_semantic_drs}
export CKPT=${CKPT:-$BASE_RUN/model_v22/best.pt}
export CAL=${CAL:-$BASE_RUN/calibration/calibration_mix_v22.json}
export GAMMA=${GAMMA:-$BASE_RUN/calibration/gamma_rec_by_bucket_v22.json}
mkdir -p "$RUN"
...
make_sel() {
  ...
  local is_v27=false
  case "$tag" in
    scalar) rel_near=false; rel_contact=false; rec_pool=false; brake_rescue=false; pcd_rescue=false ;;
    v27) rel_near=true; rel_contact=true; rec_pool=true; brake_rescue=true; pcd_rescue=true; is_v27=true ;;
  ...
  COMMON_SEL=(
    ...
    --set selection.brake_rescue_min_pred_drs_by_bucket.contact=0.64
    --set selection.brake_rescue_min_pred_drs_by_bucket.test_contact=0.64
    ...
    --set selection.brake_rescue_min_candidate_gap_by_bucket.contact=0.12
    --set selection.brake_rescue_min_candidate_gap_by_bucket.test_contact=0.12
    --set selection.brake_rescue_max_candidate_gap_by_bucket.contact=0.34
    --set selection.brake_rescue_max_candidate_gap_by_bucket.test_contact=0.34
    ...
    --set selection.pcd_rescue_macro_allowlist_by_bucket.contact=brake
    --set selection.pcd_rescue_macro_allowlist_by_bucket.test_contact=brake
    ...
    --set selection.pcd_rescue_macro_blocklist_by_bucket.contact=nominal,keep,perturb_nominal,pull_over,lane_shift,merge,yield,stabilize
    --set selection.pcd_rescue_macro_blocklist_by_bucket.test_contact=nominal,keep,perturb_nominal,pull_over,lane_shift,merge,yield,stabilize
    ...
    --set selection.pcd_rescue_min_pred_pcd_by_bucket.contact=0.34
    --set selection.pcd_rescue_min_pred_pcd_by_bucket.test_contact=0.34
    ...
    --set selection.pcd_rescue_min_pcd_gain_by_bucket.contact=-1.0
    --set selection.pcd_rescue_min_pcd_gain_by_bucket.test_contact=-1.0
    ...
    --set selection.pcd_rescue_min_pred_drs_by_bucket.contact=0.90
    --set selection.pcd_rescue_min_pred_drs_by_bucket.test_contact=0.90
    ...
    --set selection.pcd_rescue_min_pred_r_dep_by_bucket.contact=-0.75
    --set selection.pcd_rescue_min_pred_r_dep_by_bucket.test_contact=-0.75
    ...
    --set selection.pcd_rescue_max_candidate_gap_by_bucket.contact=0.34
    --set selection.pcd_rescue_max_candidate_gap_by_bucket.test_contact=0.34
    ...
    --set selection.intervention_cooldown_steps_by_bucket.near_contact=${NEAR_COOLDOWN_STEPS:-4}
    --set selection.intervention_cooldown_steps_by_bucket.test_near_contact=${NEAR_COOLDOWN_STEPS:-4}
    --set selection.intervention_cooldown_steps_by_bucket.contact=${CONTACT_COOLDOWN_STEPS:-4}
    --set selection.intervention_cooldown_steps_by_bucket.test_contact=${CONTACT_COOLDOWN_STEPS:-4}
    ...
    --set selection.rescue_challenge_min_candidate_gap_by_bucket.contact=${CONTACT_CHALLENGE_MIN_GAP:-0.16}
    --set selection.rescue_challenge_min_candidate_gap_by_bucket.test_contact=${CONTACT_CHALLENGE_MIN_GAP:-0.16}
    --set selection.rescue_challenge_max_candidate_gap_by_bucket.contact=${CONTACT_CHALLENGE_MAX_GAP:-0.24}
    --set selection.rescue_challenge_max_candidate_gap_by_bucket.test_contact=${CONTACT_CHALLENGE_MAX_GAP:-0.24}
    --set selection.rescue_challenge_min_pred_drs_by_bucket.contact=${CONTACT_CHALLENGE_MIN_DRS:-0.68}
    --set selection.rescue_challenge_min_pred_drs_by_bucket.test_contact=${CONTACT_CHALLENGE_MIN_DRS:-0.68}
    --set selection.rescue_challenge_min_pred_pcd_by_bucket.contact=${CONTACT_CHALLENGE_MIN_PCD:-0.30}
    --set selection.rescue_challenge_min_pred_pcd_by_bucket.test_contact=${CONTACT_CHALLENGE_MIN_PCD:-0.30}
    --set selection.rescue_challenge_max_pred_utility_by_bucket.contact=${CONTACT_CHALLENGE_MAX_UTILITY:-6.6}
    --set selection.rescue_challenge_max_pred_utility_by_bucket.test_contact=${CONTACT_CHALLENGE_MAX_UTILITY:-6.6}
    --set selection.rescue_challenge_max_used_by_bucket.contact=${CONTACT_CHALLENGE_MAX_USED:-3}
    --set selection.rescue_challenge_max_used_by_bucket.test_contact=${CONTACT_CHALLENGE_MAX_USED:-3}
    ...
    --set selection.intervention_budget_rate_by_bucket.contact=0.08
    ...
    --set selection.intervention_budget_hard_by_bucket.contact=false
    --set selection.intervention_budget_hard_by_bucket.test_contact=false
  ...
  if [[ "$is_v27" == "true" ]]; then
    COMMON_SEL+=(
      ...
      --set selection.brake_rescue_certificate_by_bucket.contact=true
      --set selection.brake_rescue_certificate_by_bucket.test_contact=true
      ...
      --set selection.pcd_rescue_macro_allowlist_by_bucket.contact=brake,merge,yield,stabilize
      --set selection.pcd_rescue_macro_allowlist_by_bucket.test_contact=brake,merge,yield,stabilize
      ...
      --set selection.pcd_rescue_min_pcd_gain_by_bucket.contact=0.010
      ...
      --set selection.intervention_budget_rate_by_bucket.contact=0.07
      --set selection.intervention_budget_rate_by_bucket.test_contact=0.07
      --set selection.intervention_budget_hard_by_bucket.contact=false
      --set selection.intervention_budget_hard_by_bucket.test_contact=false
      --set selection.intervention_cooldown_steps_by_bucket.contact=${CONTACT_COOLDOWN_STEPS:-3}
      --set selection.intervention_cooldown_steps_by_bucket.test_contact=${CONTACT_COOLDOWN_STEPS:-3}
      ...
      --set selection.rescue_challenge_macro_allowlist_by_bucket.near_contact=merge,yield,stabilize
      --set selection.rescue_challenge_macro_allowlist_by_bucket.test_near_contact=merge,yield,stabilize
      ...
      --set selection.rescue_challenge_min_pcd_gain_by_bucket.contact=0.020
      --set selection.rescue_challenge_min_pcd_gain_by_bucket.test_contact=0.020
      --set selection.rescue_challenge_min_rec_lcb_gain_by_bucket.contact=0.020
      --set selection.rescue_challenge_min_rec_lcb_gain_by_bucket.test_contact=0.020
      ...
      --set selection.rescue_challenge_min_gap_reduction_by_bucket.contact=0.020
      --set selection.rescue_challenge_min_gap_reduction_by_bucket.test_contact=0.020
      --set selection.rescue_challenge_min_improvement_axes_by_bucket.contact=2
      --set selection.rescue_challenge_min_improvement_axes_by_bucket.test_contact=2
      --set selection.rescue_challenge_macro_allowlist_by_bucket.contact=brake,merge,yield,stabilize
      --set selection.rescue_challenge_macro_allowlist_by_bucket.test_contact=brake,merge,yield,stabilize
      --set selection.rescue_challenge_max_used_by_bucket.contact=${CONTACT_CHALLENGE_MAX_USED:-4}
      --set selection.rescue_challenge_max_used_by_bucket.test_contact=${CONTACT_CHALLENGE_MAX_USED:-4}
      --set selection.rescue_challenge_score_pcd_weight_by_bucket.contact=1.35
      --set selection.rescue_challenge_score_pcd_weight_by_bucket.test_contact=1.35
      --set selection.rescue_challenge_score_drs_weight_by_bucket.contact=0.25
      --set selection.rescue_challenge_score_drs_weight_by_bucket.test_contact=0.25
      --set selection.rescue_challenge_score_gap_weight_by_bucket.contact=0.40
      --set selection.rescue_challenge_score_gap_weight_by_bucket.test_contact=0.40
      --set selection.rescue_challenge_nominal_guard_min_pcd_by_bucket.contact=0.50
      --set selection.rescue_challenge_nominal_guard_min_pcd_by_bucket.test_contact=0.50
...
run_eval() {
  ...
  CUDA_VISIBLE_DEVICES="$gpu" PYTHONUNBUFFERED=1 python -u -m ocrap.cli evaluate \
    ...
    --output "$RUN/eval_${d}_v27_${tag}.json" \
...
run_audit() {
  ...
  CUDA_VISIBLE_DEVICES="$gpu" PYTHONUNBUFFERED=1 python -u -m ocrap.cli closed-loop \
    ...
    --output "$RUN/audit_${b}_selected_topk_v27_${tag}.json" \
    "${COMMON_SEL[@]}" \
    ...
    | tee "$RUN/audit_${b}_selected_topk_v27_${tag}.log"
}
...
run_safe_closed_loop() {
  ...
  CUDA_VISIBLE_DEVICES=${GPU_SAFE:-0} PYTHONUNBUFFERED=1 python -u -m ocrap.cli closed-loop \
    ...
    --output "$RUN/closed_loop_safe_fast_v27.json" \
    "${COMMON_SEL[@]}" \
    --set closed_loop.method=ocrap \
    ...
    | tee "$RUN/closed_loop_safe_fast_v27.log"
}

summarize() {
  python - <<'PY' "$RUN" | tee "$RUN/summary_all_v27.txt"
import json, pathlib, sys
root=pathlib.Path(sys.argv[1])
print("\n===== Offline eval v27 =====")
for p in sorted(root.glob('eval_*_v27_*.json')):
...
for p in sorted(root.glob('*v27*.json')):
...
run_eval v27 near_contact 1 &
wait
run_eval scalar contact 0 &
run_eval v27 contact 1 &
wait

# Stress audits. Two GPUs run baseline and v24 concurrently.
run_audit scalar near_contact 0 32 384 &
run_audit v27 near_contact 1 32 384 &
wait
run_audit scalar contact 0 32 384 &
run_audit v27 contact 1 32 384 &
wait

if [[ "${RUN_NEAR_CHALLENGE_ABLATION:-0}" == "1" ]]; then
  RUN_NEAR_CHALLENGE=true RUN_NEAR_BRAKE_RESCUE=false run_eval v27 near_contact 0
  RUN_NEAR_CHALLENGE=true RUN_NEAR_BRAKE_RESCUE=false run_audit v27 near_contact 0 32 384
fi

if [[ "${RUN_DEEP_CONTACT:-0}" == "1" ]]; then
  run_audit v27 contact 0 48 640
fi
