...
EVIDENCE_ADAPT_PATIENCE="${FACTOR_PATIENCE:-${EVIDENCE_ADAPT_PATIENCE:-6}}" \
  bash scripts/adapt_ocrap_v48_28_provenance_margin_single_stage.sh
...
python tools/check_v48_28_factor_transfer.py \
...
doc={
 'event':'v48_28_two_stage_factor_admission_complete','created_unix':time.time(),
