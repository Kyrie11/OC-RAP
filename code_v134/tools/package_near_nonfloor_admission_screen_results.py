...
def main()->None:
    ...
    doc={'schema':'ocrap-v48.124.10.6-nonfloor-admission-seed-screen-result-bundle-v1','root':str(root),'pipeline_exit_code':int(a.exit_code),'complete_exit_zero':int(a.exit_code)==0,'num_files':len(entries),'files':entries}
