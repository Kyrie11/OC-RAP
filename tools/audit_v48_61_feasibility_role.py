...
def main():
    ap=argparse.ArgumentParser(description='v48.61 ERWF feasibility-role audit')
    ...
    doc={'schema':'ocrap-v48.61-erwf-feasibility-role-audit-v1','positive_gain':a.positive_gain,'arms':out,
