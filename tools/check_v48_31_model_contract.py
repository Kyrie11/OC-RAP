...
def main() -> int:
    ap = argparse.ArgumentParser(description="Fail-closed v48.31 checkpoint/inference contract audit")
    ...
    for key, expected_value in expected.items():
        ...
        if key == "direct_recovery_evidence_component_reliability":
    ...
    doc = {
        "event": "v48_31_checkpoint_inference_contract_audit",
