...
def main() -> int:
    ...
    objective_ok=objective=='signed_margin_huber'
    ...
    doc={
      'schema':'ocrap-v48.76-icsm-state-isolation-v1','valid':bool(valid),
      ...
      'absolute_feasibility_truth_contract':truth,'truth_contract_valid':truth_ok,'absolute_feasibility_supervision_objective':objective,'supervision_objective_valid':objective_ok,
    ...
    print(json.dumps({'event':'v48_76_icsm_state_isolation','valid':valid,'output':str(a.output)})); return 0 if valid else 30
