...
def main() -> int:
    ap = argparse.ArgumentParser(description="Fail-closed v48.29 checkpoint/inference contract audit")
    ...
    ap.add_argument("--expect-admission-prior-mode", choices=("risk_centered", "benefit_only"), default="benefit_only")
    args = ap.parse_args()
    ...
    doc = {
        "event": "v48_29_checkpoint_inference_contract_audit",
