...
def main():
    ap=argparse.ArgumentParser(description='v48.60 CPHR feasibility-role audit')
    ...
    doc={'schema':'ocrap-v48.60-cphr-feasibility-role-audit-v1','positive_gain':a.positive_gain,'arms':out,
    ...
    print(json.dumps({'event':'v48_60_feasibility_role_audit','output':str(a.output)}))
