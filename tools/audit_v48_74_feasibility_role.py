...
def barrier_names(arm: str):
    ...
    if arm in {"P66_OCACRW", "Q67_CTRLPROJ", "T68_FIDELITY", "D69_DTRW", "E70_OCCSOFT", "G70_OCDOTW", "H71_BOUNDARY_LOCAL", "J71_HISTORY_TUBE", "K71_OCBORW", "L72_BOX_SUPPORT", "M72_OCIORW", "N73_ANCHORED_HULL", "O73_OCSVBW"}: names.append("route")
    if arm in {"P66_OCACRW", "Q67_CTRLPROJ", "T68_FIDELITY", "D69_DTRW", "E70_OCCSOFT", "G70_OCDOTW", "H71_BOUNDARY_LOCAL", "J71_HISTORY_TUBE", "K71_OCBORW", "L72_BOX_SUPPORT", "M72_OCIORW", "N73_ANCHORED_HULL", "O73_OCSVBW"}: names.append("reentry_persistence")
    return names
