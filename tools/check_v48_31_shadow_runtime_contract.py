...
def main() -> int:
    ap = argparse.ArgumentParser(description="Fail-closed v48.31 shadow runtime contract audit")
    ...
    doc = {"event": "v48_31_shadow_runtime_contract", "valid": valid, "checks": checks}
