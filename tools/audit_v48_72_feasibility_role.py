...
def barrier_names(arm: str):
    ...
    if arm in {"P66_OCACRW", "Q67_CTRLPROJ", "T68_FIDELITY", "D69_DTRW", "E70_OCCSOFT", "G70_OCDOTW", "H71_BOUNDARY_LOCAL", "J71_HISTORY_TUBE", "K71_OCBORW", "L72_BOX_SUPPORT", "M72_OCIORW"}: names.append("route")
    if arm in {"P66_OCACRW", "Q67_CTRLPROJ", "T68_FIDELITY", "D69_DTRW", "E70_OCCSOFT", "G70_OCDOTW", "H71_BOUNDARY_LOCAL", "J71_HISTORY_TUBE", "K71_OCBORW", "L72_BOX_SUPPORT", "M72_OCIORW"}: names.append("reentry_persistence")
    return names
...
def main():
    ap=argparse.ArgumentParser(description='v48.72 OC-IORW feasibility-role and interaction-reachability witness audit')
    ...
    doc={
        'schema':'ocrap-v48.72-iorw-feasibility-role-audit-v1','positive_gain':a.positive_gain,'arms':out,
    ...
    print(json.dumps({'event':'v48_72_iorw_feasibility_role_audit','output':str(a.output)}))
