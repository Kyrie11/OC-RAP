...
def main() -> int:
    ap = argparse.ArgumentParser(description="Fail-closed v48.29 shadow runtime contract audit")
    ...
    doc = {"event": "v48_29_shadow_runtime_contract", "valid": valid, "checks": checks}
