...
from ocrap.audits.weak_root_recovery_set_flow import ENGINEERING_VERSION, SCIENTIFIC_VERSION

EXPECTED = {
    "runtime": "OC-RAP-v48.116-runtime-code-contract.json",
    "balanced": "OC-RAP-v48.116-WRCF-balanced.json",
    "precision": "OC-RAP-v48.116-WRCF-precision.json",
    "balanced_state": "OC-RAP-v48.116-WRCF-balanced.pt",
    "precision_state": "OC-RAP-v48.116-WRCF-precision.pt",
    "comparison": "OC-RAP-v48.116-DCP-DRFC-BCDE-RIFA-OC-WRCF-comparison.json",
}
PIPELINE_NAME = "OC-RAP-v48.116-PIPELINE_COMPLETE.json"
MANIFEST_NAME = "OC-RAP-v48.116-OC-WRCF-result-bundle-manifest.json"
RESULT_NAME = "OC-RAP-v48.116-OC-WRCF-results.zip"
...
def main() -> int:
    ...
    stale = sorted(str(p) for p in a.base_out.glob("OC-RAP-v48.116-*") if p.name not in allowed)
    if stale:
        errors.append("noncanonical_v48_116_artifacts_present")
    ...
    manifest = {
        "schema": "ocrap-v48.116-wrcf-result-bundle-manifest-v1",
        ...
        "files": files,
        "noncanonical_v48_116_artifacts": stale,
    }
