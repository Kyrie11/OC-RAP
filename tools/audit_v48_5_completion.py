...
def main() -> int:
    ...
    out=args.output or root/'completion_audit_v48_5.json'; out.parent.mkdir(parents=True,exist_ok=True); out.write_text(json.dumps(doc,ensure_ascii=False,indent=2)+'\n')
