...
def main():
 ...
 out={'schema':'ocrap-v48.91-pipeline-complete-v1','engineering_version':'v48.91.3-OC-CEPMI-REPLAYFIX','valid':not errors,'attribution_ready':not errors,'errors':errors,'experiment_type':'audit_only_common_exogenous_future_physical_margin_identifiability','planner_parameters_trained':0,'dataset_reconstruction':False,'dataset_reselection':False,'teacher_labels_changed':False,'teacher_metadata_input_to_model':False,'boundary_transport':False,'relative_ranker_modified':False,'regime_conditioning':False,'test_roots_read':False,'artifacts':artifacts,'preregistered_status':(docs.get('comparison',{}).get('preregistered_decision') or {}).get('status')}
