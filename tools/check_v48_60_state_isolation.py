...
def main() -> int:
    ap=argparse.ArgumentParser(description='v48.60 fail-closed CPHR frozen-Stage-I isolation audit')
    ...
    doc={
      ...
      'allowed_trainable_key':ALLOWED_KEY,'expected_num_weights':EXPECTED_NUM_OPTIONS,
    ...
    print(json.dumps({'event':'v48_60_cphr_state_isolation','valid':valid,'output':str(a.output)}))
