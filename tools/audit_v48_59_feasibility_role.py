...
def main():
    ap=argparse.ArgumentParser(description='v48.59 ORFC feasibility-role audit')
    ...
    doc={'schema':'ocrap-v48.59-orfc-feasibility-role-audit-v1','positive_gain':a.positive_gain,'arms':out,
    ...
    print(json.dumps({'event':'v48_59_feasibility_role_audit','output':str(a.output)}))
