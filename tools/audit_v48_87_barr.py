...
def main():
    ...
    comps={}
    for name,base,new in [('U87_minus_S86',a.s86,a.u87),('V87_minus_T86',a.t86,a.v87),('V87_minus_U87',a.u87,a.v87),('V87_minus_L80',a.l80,a.v87)]:
        comps[name]={v:{s:compare(rows(base,v,s),rows(new,v,s),s,t) for s in KINDS} for v in VARS}
    doc={
      'schema':'ocrap-v48.87-barr-audit-v1','engineering_version':'v48.87.0-OC-BARR',
