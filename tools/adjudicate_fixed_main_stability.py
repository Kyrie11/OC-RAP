...
def main() -> int:
    ...
    try:
        ...
        if full_engineering == FROZEN_FULL_RUN_ENGINEERING_VERSION:
            ...
            # Fresh V48.124.8 evidence must be generated by the same checkout
            # that performs adjudication.  Compare every recorded runtime file
            # against its current bytes instead of pinning a historical hash.
