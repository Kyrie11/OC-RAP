...
from ocrap.v48_91_common_exogenous_physical_margin import ENGINEERING_VERSION, physical_margin_from_teacher_diag
FILES=(
 ...
 'src/ocrap/data/waymax_loader.py','src/ocrap/simulation/waymax_rollout.py',
 'tools/build_v48_91_common_exogenous_physical_response_audit.py','tools/check_v48_91_calibration_source_contract.py',
 'tools/compare_v48_91_cepmi.py','tools/check_v48_91_pipeline_complete.py','tools/check_v48_91_runtime_code_contract.py')
MODULES=('ocrap','ocrap.data.waymax_loader','ocrap.simulation.waymax_rollout','ocrap.v48_89_root_correspondence','ocrap.v48_90_partition_transport','ocrap.v48_91_common_exogenous_physical_margin')
def sha(p):
 h=hashlib.sha256();
