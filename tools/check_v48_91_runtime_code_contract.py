...
MODULES=('ocrap','ocrap.v48_89_root_correspondence','ocrap.v48_90_partition_transport','ocrap.v48_91_common_exogenous_physical_margin')
def sha(p):
 h=hashlib.sha256();
