...
RUNTIME_FILES=(
    ...
    'tools/build_contact_anchor_manifest.py',
...
def main() -> int:
    ...
    synthetic={
        ...
        'contact_anchor_exact_a0_pretreatment_supported': 'exact_a0_pretreatment_prelude_v1' in (repo/'src/ocrap/simulation/closed_loop_runner.py').read_text(encoding='utf-8'),
        'contact_anchor_state_fingerprint_required': 'same_pre_treatment_anchor_fingerprints' in (repo/'src/ocrap/audits/fixed_main_stability.py').read_text(encoding='utf-8'),
        'contact_anchor_scene_disjoint_manifest_builder_present': (repo/'tools/build_contact_anchor_manifest.py').is_file(),
