...
def main():
    ap=argparse.ArgumentParser(description='v48.62 OC-CWRF feasibility-role audit')
    ...
    doc={'schema':'ocrap-v48.62-occwrf-feasibility-role-audit-v1','positive_gain':a.positive_gain,'arms':out,
    ...
    print(json.dumps({'event':'v48_61_feasibility_role_audit','output':str(a.output)}))
