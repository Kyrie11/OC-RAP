...
def barrier_names(arm: str):
    ...
    if arm in {"P66_OCACRW", "Q67_CTRLPROJ", "T68_FIDELITY", "D69_DTRW"}: names.append("route")
    if arm in {"P66_OCACRW", "Q67_CTRLPROJ", "T68_FIDELITY", "D69_DTRW"}: names.append("reentry_persistence")
    return names
...
def main():
    ap=argparse.ArgumentParser(description='v48.69 OC-DTRW feasibility-role and active-demand witness audit')
    ...
    doc={
        'schema':'ocrap-v48.69-dtrw-feasibility-role-audit-v1','positive_gain':a.positive_gain,'arms':out,
    ...
    print(json.dumps({'event':'v48_69_dtrw_feasibility_role_audit','output':str(a.output)}))
