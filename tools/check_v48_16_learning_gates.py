    ...
    for variant in ('balanced','precision'):
        ...
        for regime in ('near','contact'):
            ...
            item['certificate'][regime]={
                ...
                'num_groups':finite(risk.get('num_groups')),
                'num_scenes':finite(risk.get('num_scenes')),
                'fit_groups':finite(risk.get('fit_groups')),
                'verify_groups':finite(risk.get('verify_groups')),
