#!/usr/bin/env python3
"""Compare v48.43 POET A/B/C/D on development/certificate data only.

The report intentionally does not read test roots.  It extracts the exact metrics
needed for the pre-registered POET causal readout and recomputes component-level
...
def main() -> int:
    ...
    args = ap.parse_args()
    report = {
        "schema": "v48.43-poet-2x2-comparison-v1",
