...
def main() -> int:
    ...
    doc={
        'schema':'ocrap-v48.57-reference-reuse-contract-v1','valid':valid,
        ...
        'reuse_rationale':'v48.57 changes only deployment-side predicted-root integration measure; teacher/component semantics and protocol are identical to fresh v48.56-A',
        'test_roots_read':False,
    }
    args.output.parent.mkdir(parents=True,exist_ok=True)
    args.output.write_text(json.dumps(doc,indent=2,sort_keys=True)+'\n',encoding='utf-8')
    print(json.dumps({'event':'v48_57_reference_reuse_check','valid':valid,'output':str(args.output)}))
