...
def main() -> int:
    ap = argparse.ArgumentParser(description="Check OC-RAP v33 brake-tail regime targets from closed-loop/audit JSON outputs.")
    ...
    root = args.run_dir
    files = {
        "safe": root / "closed_loop_safe_fast_v33.json",
        "near": root / "audit_near_contact_selected_topk_v33_v33.json",
        "contact": root / "audit_contact_selected_topk_v33_v33.json",
    }
