...
def main():
    ...
    ap.add_argument('--r85',type=Path,required=True)
    ...
    comps={}
    for name,base,new in [('Q85_minus_L80',a.l80,a.q85),('R85_minus_Q85',a.q85,a.r85),('R85_minus_L80',a.l80,a.r85)]:
        comps[name]={v:{s:compare(rows(base,v,s),rows(new,v,s),s,t) for s in KINDS} for v in VARS}
    doc={
      'schema':'ocrap-v48.85-sarr-audit-v1','engineering_version':'v48.85.1-OC-SARR-ENGFIX',
