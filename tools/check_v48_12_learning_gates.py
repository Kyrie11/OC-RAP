...
def main() -> int:
    ap = argparse.ArgumentParser(description="Audit v48.12 TRIDENT recovery-pair tournament, bipolar ordered evidence, and Natural gate.")
    ...
    for variant in ("balanced", "precision"):
        ...
        for regime in ("near", "contact"):
            ...
            pref = _load(base / "stages" / "set_tournament" / "preference_audit" / f"preference_{regime}.json")
            ...
            row["certificate"][regime] = {
                ...
                "oracle_positive_macro_share": verify.get("oracle_positive_max_macro_share"),
