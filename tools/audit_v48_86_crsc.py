...
def main():
    ...
    ap.add_argument('--q85',type=Path,required=True)
    ...
    comps={}
    for name,base,new in [('S86_minus_Q85',a.q85,a.s86),('T86_minus_S86',a.s86,a.t86),('T86_minus_L80',a.l80,a.t86)]:
        comps[name]={v:{s:compare(rows(base,v,s),rows(new,v,s),s,t) for s in KINDS} for v in VARS}
    doc={
      'schema':'ocrap-v48.86-crsc-audit-v1','engineering_version':'v48.86.0-OC-CRSC',
