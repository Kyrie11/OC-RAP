...
def main():
    ...
    ap.add_argument('--s86',type=Path,required=True)
    ap.add_argument('--t86',type=Path,required=True)
    ap.add_argument('--u87',type=Path,required=True)
    ap.add_argument('--v87',type=Path,required=True)
    ap.add_argument('--w88',type=Path,required=True)
    ap.add_argument('--x88',type=Path,required=True)
    ...
    comps={}
    for name,base,new in [('W88_minus_U87',a.u87,a.w88),('X88_minus_V87',a.v87,a.x88),('W88_minus_S86',a.s86,a.w88),('X88_minus_T86',a.t86,a.x88),('X88_minus_W88',a.w88,a.x88),('X88_minus_L80',a.l80,a.x88)]:
        comps[name]={v:{s:compare(rows(base,v,s),rows(new,v,s),s,t) for s in KINDS} for v in VARS}
    doc={
      'schema':'ocrap-v48.88-qtrr-audit-v1','engineering_version':'v48.88.0-OC-QTRR',
