...
def main() -> int:
    ...
    doc={'event':'v48_33_failure_signature','created_unix':time.time(),'stage':args.stage,'exit_code':args.exit_code,'log':str(args.log),'exception_type':exception_type,'message':message,'location':location,'tail':'\n'.join(lines[-120:])}
