...
def main():
 ...
 doc={'schema':'ocrap-v48.81-sitc-audit-v1','engineering_version':'v48.81.2-OC-SITC-ENGFIX','comparisons':{'M81_minus_L80':c},'truth_index_summary':json.loads(a.truth_summary.read_text()),'v48_80_truth_index_summary':json.loads(a.v80_truth_summary.read_text()),'teacher_labels_changed':False,'teacher_future_input_to_model':False,'dataset_reconstruction':False,'test_roots_read':False,'valid':True}
