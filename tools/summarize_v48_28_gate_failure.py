    ...
    for variant in ('balanced','precision'):
        ...
        for regime in ('near','contact'):
            ...
            regimes[regime]={
                ...
                'proposal_evidence_safe_positive_auc':cert.get('proposal_evidence_top1_safe_positive_auc'),
                'proposal_evidence_harm_auc':cert.get('proposal_evidence_top1_harm_auc'),
                'proposal_evidence_correlation':cert.get('proposal_evidence_top1_correlation'),
            }
            overall.append(layer)
        variants[variant]=regimes
    result={
        'event':'v48_28_gate_failure_decomposition',
        'run':str(args.run),
