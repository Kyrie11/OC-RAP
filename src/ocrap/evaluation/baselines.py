    ...
    if method == "ocrap":
        ...
        if selector_name in {"calibrated", "calibrated_constrained", "soft_constrained", "budgeted_calibrated"}:
            sel = calibrated_constrained_select(
                ...
                direct_value_proposal_top_k=int(_cfg_float(scfg, "direct_value_proposal_top_k", 1.0, bucket_name)),
                direct_value_evidence_rerank_top_k=_cfg_bool(scfg, "direct_value_evidence_rerank_top_k", False, bucket_name),
