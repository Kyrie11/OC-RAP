...
def _direct_value_loss_from_outputs(
    ...
    *,
    ...
    base_kwargs = dict(
        ...
        ordinal_evidence_hard_harm_weight=float(tcfg.get("direct_value_ordinal_evidence_hard_harm_weight", 0.0)),
        ...
        evidence_calibrator_anchor_weight=float(tcfg.get("direct_value_evidence_calibrator_anchor_weight", 0.0)),
...
def train(dataset: str, output: str, cfg: dict, val_dataset: str | None = None) -> dict:
    ...
    def _checkpoint_payload(ep: int, val_loss: float) -> dict:
        return {
            ...
            "direct_recovery_absolute_executable_witness_feature_schema": (
                1 if bool(model_cfg.get("direct_recovery_absolute_executable_witness_correction", False)) else 0
            ),
