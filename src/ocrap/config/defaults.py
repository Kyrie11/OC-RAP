...
DEFAULT_CONFIG: dict[str, Any] = {
    ...
    "training": {"device": "auto", "require_cuda": False, "progress": True, "batch_size": 16, "num_workers": 0, "epochs": 1, "lr": 0.001, "weight_decay": 0.0001, "grad_clip": 5.0, "artifact_sampler_weight": 0.25, "negative_deployable_sampler_weight": 0.75, "safe_positive_sampler_weight": 0.25, "root_target_mode": "recovery_signature", "val_dataset": None, "balanced_obs_loss": True},
    "loss_weights": {"assign": 1.0, "sig": 0.5, "ib": 0.01, "obs": 1.0, "margin": 2.0, "anti_oracle": 1.0, "artifact_gap": 0.5, "admission": 0.2, "option_q": 0.5, "option_admission": 0.4, "option_best": 0.2, "utility": 0.2},
