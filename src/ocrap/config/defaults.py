...
DEFAULT_CONFIG: dict[str, Any] = {
    ...
    "closed_loop": {"max_scenarios": 8, "start_time_index": None, "max_steps": 40, "replan_interval_steps": 1, "method": "ocrap", "artifact_mine_probability": 0.0, "render": False, "save_trace_npz": False},
