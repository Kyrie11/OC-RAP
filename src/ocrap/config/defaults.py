...
DEFAULT_CONFIG: dict[str, Any] = {
    ...
    "evaluation": {"batch_size": 64, "delta": 0.05, "allow_infinite_gamma": False, "group_by_dataset": True, "methods": ["nominal", "risk_aware", "backup_filter", "contingency", "oracle_filter", "ocrap"]},
    "closed_loop": {
        "max_scenarios": 8,
