...
DEFAULT_CONFIG: dict[str, Any] = {
    ...
    "loss_weights": {"assign": 1.0, "sig": 0.5, "ib": 0.01, "obs": 1.0, "margin": 2.0, "anti_oracle": 1.0, "artifact_gap": 0.5, "admission": 0.2, "option_q": 0.5, "option_admission": 0.4, "option_success": 0.5, "option_success_bce": 0.0, "option_best": 0.2, "utility": 0.2},
