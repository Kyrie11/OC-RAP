...
All MetaDrive internal access is centralized in `MetaDriveStateAdapter`. Missing fields are recorded in metadata and must not be silently treated as real sensor values.
